...
class PygOurDataset(InMemoryDataset):
    def __init__(self, root = 'dataset', phase = 'train', dataname = 'hiv', smiles2graph = smiles2graph, transform=None, pre_transform = None):
        '''
        ...
        self.phase = phase
        self.aug = 'none'
        self.tokenizer = RobertaTokenizerFast.from_pretrained('seyonec/ChemBERTa_zinc250k_v2_40k', max_len=100)
